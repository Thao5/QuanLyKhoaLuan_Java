...
<section class="container">
    ...
    <c:if test="${pages > 1}">
        <ul class="pagination mt-1">
            <li class="page-item"><a class="page-link" href="<c:url value="/admin/nguoidungs"/>">Tất cả</a></li>
                <c:forEach begin="1" end="${pages}" var="i">
                    <c:url value="/admin/nguoidungs" var="pageUrl">
        ...
        <tbody>
            <c:forEach items="${nguoiDungs}" var="nd">
                <tr>
                    ...
                    <td>
                        <button onclick="del('<c:url value="/admin/deletenguoidung/${nd.id}/"/>')" title="Xóa người dùng" class="btn btn-outline-danger">-</button>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
